...
target_columns = [
    'participant_id','age','gender','response','accuracy','education','handedness','country_of_residence','years_spent_in_countries_of_residence','response','rt'
]

drop_columns = ['Number of participant']
