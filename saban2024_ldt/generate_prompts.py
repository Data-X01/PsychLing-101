...
#Define the path
path = Path("C:/Users/ivasa/Documents/PsyLing101/My contribution - Italian LDT with colour words/Fixing again") / "prompts.jsonl"

#Load preprocessed files from Exp1 and Exp2
df1 = pd.read_csv("C:/Users/ivasa/Documents/PsyLing101/My contribution - Italian LDT with colour words/Fixing again/processed_data/exp1.csv", sep=';')
df2 = pd.read_csv("C:/Users/ivasa/Documents/PsyLing101/My contribution - Italian LDT with colour words/Fixing again/processed_data/exp2.csv", sep=';')
